...
const vocabulary: VocabularyItem[] = [
  ...
  { arabic: "أَسَد", transliteration: "Asad", meaning: "Lion", example: "الْأَسَدُ مَلِكُ الْغَابَةِ.", category: "Animals", color: "coral", colloquial: "أَسَد", colloquialTransliteration: "Asad" , image: "🦁" },
  { arabic: "فِيل", transliteration: "Feel", meaning: "Elephant", example: "الْفِيلُ حَيَوَانٌ ضَخْمٌ.", category: "Animals", color: "gold", colloquial: "فِيل", colloquialTransliteration: "Feel" , image: "🐘" },
  { arabic: "جَمَل", transliteration: "Jamal", meaning: "Camel", example: "الْجَمَلُ يَعِيشُ فِي الصَّحْرَاءِ.", category: "Animals", color: "sage", colloquial: "جَمَل", colloquialTransliteration: "Jamal" , image: "🐫" },
  { arabic: "حِصَان", transliteration: "Hisaan", meaning: "Horse", example: "الْحِصَانُ يَجْرِي بِسُرْعَةٍ.", category: "Animals", color: "blue", colloquial: "خَيْل", colloquialTransliteration: "Khayl" , image: "🐴" },
  { arabic: "بَقَرَة", transliteration: "Baqarah", meaning: "Cow", example: "الْبَقَرَةُ تُعْطِينَا الْحَلِيبَ.", category: "Animals", color: "coral", colloquial: "بَقَرَة", colloquialTransliteration: "Baqarah" , image: "🐄" },
  { arabic: "خَرُوف", transliteration: "Kharoof", meaning: "Sheep", example: "الْخَرُوفُ صُوفُهُ نَاعِمٌ.", category: "Animals", color: "gold", colloquial: "خَرُوف", colloquialTransliteration: "Kharoof" , image: "🐑" },
  { arabic: "أَرْنَب", transliteration: "Arnab", meaning: "Rabbit", example: "الْأَرْنَبُ يُحِبُّ الْجَزَرَ.", category: "Animals", color: "sage", colloquial: "أَرْنَب", colloquialTransliteration: "Arnab" , image: "🐰" },
  { arabic: "طَائِر", transliteration: "Taa'ir", meaning: "Bird", example: "الطَّائِرُ يُغَرِّدُ فَوْقَ الشَّجَرَةِ.", category: "Animals", color: "blue", colloquial: "طِير", colloquialTransliteration: "Teer" , image: "🐦" },
  { arabic: "سَمَكَة", transliteration: "Samakah", meaning: "Fish", example: "السَّمَكَةُ تَسْبَحُ فِي الْبَحْرِ.", category: "Animals", color: "coral", colloquial: "سَمَكَة", colloquialTransliteration: "Samakah" , image: "🐟" },
  { arabic: "دَجَاجَة", transliteration: "Dajaajah", meaning: "Chicken", example: "الدَّجَاجَةُ تَضَعُ الْبَيْضَ.", category: "Animals", color: "gold", colloquial: "فَرُّوج", colloquialTransliteration: "Farrouj" , image: "🐔" },
  { arabic: "بَطَّة", transliteration: "Battah", meaning: "Duck", example: "الْبَطَّةُ تَسْبَحُ فِي الْبِرْكَةِ.", category: "Animals", color: "sage", colloquial: "بَطَّة", colloquialTransliteration: "Battah" , image: "🦆" },
  { arabic: "قِرْد", transliteration: "Qird", meaning: "Monkey", example: "الْقِرْدُ يَتَسَلَّقُ الْأَشْجَارَ.", category: "Animals", color: "blue", colloquial: "قِرْد", colloquialTransliteration: "Qird" , image: "🐒" },
  { arabic: "دُبّ", transliteration: "Dubb", meaning: "Bear", example: "الدُّبُّ كَبِيرٌ وَقَوِيٌّ.", category: "Animals", color: "coral", colloquial: "دُبّ", colloquialTransliteration: "Dubb" , image: "🐻" },
  { arabic: "نَمِر", transliteration: "Namir", meaning: "Tiger", example: "النَّمِرُ سَرِيعٌ جِدًّا.", category: "Animals", color: "gold", colloquial: "نَمِر", colloquialTransliteration: "Namir" , image: "🐯" },
  { arabic: "فَأْر", transliteration: "Fa'r", meaning: "Mouse", example: "الْفَأْرُ صَغِيرٌ وَسَرِيعٌ.", category: "Animals", color: "sage", colloquial: "فَار", colloquialTransliteration: "Faar" , image: "🐭" },
  { arabic: "ثَعْبَان", transliteration: "Thu'baan", meaning: "Snake", example: "الثُّعْبَانُ يَزْحَفُ عَلَى الْأَرْضِ.", category: "Animals", color: "blue", colloquial: "حَيَّة", colloquialTransliteration: "Hayyah" , image: "🐍" },
  { arabic: "سُلَحْفَاة", transliteration: "Sulahfah", meaning: "Turtle", example: "السُّلَحْفَاةُ تَمْشِي بِبُطْءٍ.", category: "Animals", color: "coral", colloquial: "سُلَحْفَاة", colloquialTransliteration: "Sulahfah" , image: "🐢" },
  { arabic: "ضِفْدَع", transliteration: "Difda'", meaning: "Frog", example: "الضِّفْدَعُ يَقْفِزُ عَالِيًا.", category: "Animals", color: "gold", colloquial: "ضِفْدَع", colloquialTransliteration: "Difda'" , image: "🐸" },
  { arabic: "حِمَار", transliteration: "Himaar", meaning: "Donkey", example: "الْحِمَارُ يَحْمِلُ الْأَغْرَاضَ.", category: "Animals", color: "sage", colloquial: "حِمَار", colloquialTransliteration: "Himaar" , image: "🫏" },
  { arabic: "ثَعْلَب", transliteration: "Tha'lab", meaning: "Fox", example: "الثَّعْلَبُ ذَكِيٌّ وَمَاكِرٌ.", category: "Animals", color: "blue", colloquial: "ثَعْلَب", colloquialTransliteration: "Tha'lab" , image: "🦊" },
  { arabic: "ذِئْب", transliteration: "Thi'b", meaning: "Wolf", example: "الذِّئْبُ يَعِيشُ فِي قَطِيعٍ.", category: "Animals", color: "coral", colloquial: "ذِيب", colloquialTransliteration: "Theeb" , image: "🐺" },
  { arabic: "غَزَال", transliteration: "Ghazaal", meaning: "Deer", example: "الْغَزَالُ يَجْرِي بِرَشَاقَةٍ.", category: "Animals", color: "gold", colloquial: "غَزَال", colloquialTransliteration: "Ghazaal" , image: "🦌" },
  { arabic: "تُفَّاح", transliteration: "Tuffaah", meaning: "Apple", example: "أَكَلْتُ تُفَّاحَةً حَمْرَاءَ.", category: "Fruits", color: "sage", colloquial: "تُفَّاح", colloquialTransliteration: "Tuffaah" , image: "🍎" },
  { arabic: "مَوْز", transliteration: "Mawz", meaning: "Banana", example: "الْمَوْزُ غَنِيٌّ بِالطَّاقَةِ.", category: "Fruits", color: "blue", colloquial: "مَوْز", colloquialTransliteration: "Mawz" , image: "🍌" },
  { arabic: "بُرْتُقَال", transliteration: "Burtuqaal", meaning: "Orange", example: "شَرِبْتُ عَصِيرَ الْبُرْتُقَالِ.", category: "Fruits", color: "coral", colloquial: "بُرْتُقَال", colloquialTransliteration: "Burtuqaal" , image: "🍊" },
  { arabic: "عِنَب", transliteration: "Inab", meaning: "Grape", example: "الْعِنَبُ حُلْوٌ وَطَازَجٌ.", category: "Fruits", color: "gold", colloquial: "عِنَب", colloquialTransliteration: "Inab" , image: "🍇" },
  { arabic: "بَطِّيخ", transliteration: "Battikh", meaning: "Watermelon", example: "الْبَطِّيخُ لَذِيذٌ فِي الصَّيْفِ.", category: "Fruits", color: "sage", colloquial: "حَبْحَب", colloquialTransliteration: "Habhab" , image: "🍉" },
  { arabic: "فَرَاوْلَة", transliteration: "Frawlah", meaning: "Strawberry", example: "الْفَرَاوْلَةُ حَمْرَاءُ وَحُلْوَةٌ.", category: "Fruits", color: "blue", colloquial: "فَرَاوْلَة", colloquialTransliteration: "Frawlah" , image: "🍓" },
  { arabic: "مَانْجَا", transliteration: "Mangaa", meaning: "Mango", example: "الْمَانْجَا فَاكِهَةٌ اسْتِوَائِيَّةٌ.", category: "Fruits", color: "coral", colloquial: "مَانْجَا", colloquialTransliteration: "Mangaa" , image: "🥭" },
  { arabic: "أَنَانَاس", transliteration: "Ananaas", meaning: "Pineapple", example: "الْأَنَانَاسُ حَامِضٌ وَحُلْوٌ.", category: "Fruits", color: "gold", colloquial: "أَنَانَاس", colloquialTransliteration: "Ananaas" , image: "🍍" },
  { arabic: "كُمَّثْرَى", transliteration: "Kummathra", meaning: "Pear", example: "الْكُمَّثْرَى طَرِيَّةٌ وَعَصِيرِيَّةٌ.", category: "Fruits", color: "sage", colloquial: "كُمَّثْرَى", colloquialTransliteration: "Kummathra" , image: "🍐" },
  { arabic: "خَوْخ", transliteration: "Khawkh", meaning: "Peach", example: "الْخَوْخُ فَاكِهَةُ الصَّيْفِ.", category: "Fruits", color: "blue", colloquial: "خَوْخ", colloquialTransliteration: "Khawkh" , image: "🍑" },
  { arabic: "كَرَز", transliteration: "Karaz", meaning: "Cherry", example: "الْكَرَزُ صَغِيرٌ وَلَذِيذٌ.", category: "Fruits", color: "coral", colloquial: "كَرَز", colloquialTransliteration: "Karaz" , image: "🍒" },
  { arabic: "لَيْمُون", transliteration: "Laymoon", meaning: "Lemon", example: "أُضِيفُ اللَّيْمُونَ إِلَى الشَّايِ.", category: "Fruits", color: "gold", colloquial: "لَيْمُون", colloquialTransliteration: "Laymoon" , image: "🍋" },
  ...
  { arabic: "جَوْزُ الْهِنْد", transliteration: "Jawz al-Hind", meaning: "Coconut", example: "جَوْزُ الْهِنْدِ يَحْتَوِي عَلَى مَاءٍ لَذِيذٍ.", category: "Fruits", color: "blue", colloquial: "نَارْجِيل", colloquialTransliteration: "Narjeel" , image: "🥥" },
  { arabic: "شَمَّام", transliteration: "Shammaam", meaning: "Melon", example: "الشَّمَّامُ مُنْعِشٌ فِي الصَّيْفِ.", category: "Fruits", color: "coral", colloquial: "شَمَّام", colloquialTransliteration: "Shammaam" , image: "🍈" },
  { arabic: "كِيوِي", transliteration: "Kiwi", meaning: "Kiwi", example: "الْكِيوِي أَخْضَرُ مِنْ الدَّاخِلِ.", category: "Fruits", color: "gold", colloquial: "كِيوِي", colloquialTransliteration: "Kiwi" , image: "🥝" },
...
const englishVocabulary: VocabularyItem[] = [
  ...
  { arabic: "Lion", transliteration: "Lion", meaning: "أَسَد", example: "The lion is the king of the jungle.", category: "Animals", color: "coral", colloquial: "أَسَد", colloquialTransliteration: "Asad" , image: "🦁" },
  { arabic: "Elephant", transliteration: "Elephant", meaning: "فِيل", example: "The elephant is a huge animal.", category: "Animals", color: "gold", colloquial: "فِيل", colloquialTransliteration: "Feel" , image: "🐘" },
  { arabic: "Camel", transliteration: "Camel", meaning: "جَمَل", example: "The camel lives in the desert.", category: "Animals", color: "sage", colloquial: "جَمَل", colloquialTransliteration: "Jamal" , image: "🐫" },
  { arabic: "Horse", transliteration: "Horse", meaning: "حِصَان", example: "The horse runs very fast.", category: "Animals", color: "blue", colloquial: "خَيْل", colloquialTransliteration: "Khayl" , image: "🐴" },
  { arabic: "Cow", transliteration: "Cow", meaning: "بَقَرَة", example: "The cow gives us milk.", category: "Animals", color: "coral", colloquial: "بَقَرَة", colloquialTransliteration: "Baqarah" , image: "🐄" },
  { arabic: "Sheep", transliteration: "Sheep", meaning: "خَرُوف", example: "The sheep has soft wool.", category: "Animals", color: "gold", colloquial: "خَرُوف", colloquialTransliteration: "Kharoof" , image: "🐑" },
  { arabic: "Rabbit", transliteration: "Rabbit", meaning: "أَرْنَب", example: "The rabbit loves carrots.", category: "Animals", color: "sage", colloquial: "أَرْنَب", colloquialTransliteration: "Arnab" , image: "🐰" },
  { arabic: "Bird", transliteration: "Bird", meaning: "طَائِر", example: "The bird sings on the tree.", category: "Animals", color: "blue", colloquial: "طِير", colloquialTransliteration: "Teer" , image: "🐦" },
  { arabic: "Fish", transliteration: "Fish", meaning: "سَمَكَة", example: "The fish swims in the sea.", category: "Animals", color: "coral", colloquial: "سَمَكَة", colloquialTransliteration: "Samakah" , image: "🐟" },
  { arabic: "Chicken", transliteration: "Chicken", meaning: "دَجَاجَة", example: "The chicken lays eggs.", category: "Animals", color: "gold", colloquial: "فَرُّوج", colloquialTransliteration: "Farrouj" , image: "🐔" },
  { arabic: "Duck", transliteration: "Duck", meaning: "بَطَّة", example: "The duck swims in the pond.", category: "Animals", color: "sage", colloquial: "بَطَّة", colloquialTransliteration: "Battah" , image: "🦆" },
  { arabic: "Monkey", transliteration: "Monkey", meaning: "قِرْد", example: "The monkey climbs the trees.", category: "Animals", color: "blue", colloquial: "قِرْد", colloquialTransliteration: "Qird" , image: "🐒" },
  { arabic: "Bear", transliteration: "Bear", meaning: "دُبّ", example: "The bear is big and strong.", category: "Animals", color: "coral", colloquial: "دُبّ", colloquialTransliteration: "Dubb" , image: "🐻" },
  { arabic: "Tiger", transliteration: "Tiger", meaning: "نَمِر", example: "The tiger is very fast.", category: "Animals", color: "gold", colloquial: "نَمِر", colloquialTransliteration: "Namir" , image: "🐯" },
  { arabic: "Mouse", transliteration: "Mouse", meaning: "فَأْر", example: "The mouse is small and quick.", category: "Animals", color: "sage", colloquial: "فَار", colloquialTransliteration: "Faar" , image: "🐭" },
  { arabic: "Snake", transliteration: "Snake", meaning: "ثَعْبَان", example: "The snake crawls on the ground.", category: "Animals", color: "blue", colloquial: "حَيَّة", colloquialTransliteration: "Hayyah" , image: "🐍" },
  { arabic: "Turtle", transliteration: "Turtle", meaning: "سُلَحْفَاة", example: "The turtle walks slowly.", category: "Animals", color: "coral", colloquial: "سُلَحْفَاة", colloquialTransliteration: "Sulahfah" , image: "🐢" },
  { arabic: "Frog", transliteration: "Frog", meaning: "ضِفْدَع", example: "The frog jumps high.", category: "Animals", color: "gold", colloquial: "ضِفْدَع", colloquialTransliteration: "Difda'" , image: "🐸" },
  { arabic: "Donkey", transliteration: "Donkey", meaning: "حِمَار", example: "The donkey carries the load.", category: "Animals", color: "sage", colloquial: "حِمَار", colloquialTransliteration: "Himaar" , image: "🫏" },
  { arabic: "Fox", transliteration: "Fox", meaning: "ثَعْلَب", example: "The fox is smart and cunning.", category: "Animals", color: "blue", colloquial: "ثَعْلَب", colloquialTransliteration: "Tha'lab" , image: "🦊" },
  { arabic: "Wolf", transliteration: "Wolf", meaning: "ذِئْب", example: "The wolf lives in a pack.", category: "Animals", color: "coral", colloquial: "ذِيب", colloquialTransliteration: "Theeb" , image: "🐺" },
  { arabic: "Deer", transliteration: "Deer", meaning: "غَزَال", example: "The deer runs gracefully.", category: "Animals", color: "gold", colloquial: "غَزَال", colloquialTransliteration: "Ghazaal" , image: "🦌" },
  { arabic: "Apple", transliteration: "Apple", meaning: "تُفَّاح", example: "I ate a red apple.", category: "Fruits", color: "sage", colloquial: "تُفَّاح", colloquialTransliteration: "Tuffaah" , image: "🍎" },
  { arabic: "Banana", transliteration: "Banana", meaning: "مَوْز", example: "The banana is full of energy.", category: "Fruits", color: "blue", colloquial: "مَوْز", colloquialTransliteration: "Mawz" , image: "🍌" },
  { arabic: "Orange", transliteration: "Orange", meaning: "بُرْتُقَال", example: "I drank orange juice.", category: "Fruits", color: "coral", colloquial: "بُرْتُقَال", colloquialTransliteration: "Burtuqaal" , image: "🍊" },
  { arabic: "Grape", transliteration: "Grape", meaning: "عِنَب", example: "The grape is sweet and fresh.", category: "Fruits", color: "gold", colloquial: "عِنَب", colloquialTransliteration: "Inab" , image: "🍇" },
  { arabic: "Watermelon", transliteration: "Watermelon", meaning: "بَطِّيخ", example: "Watermelon is delicious in summer.", category: "Fruits", color: "sage", colloquial: "حَبْحَب", colloquialTransliteration: "Habhab" , image: "🍉" },
  { arabic: "Strawberry", transliteration: "Strawberry", meaning: "فَرَاوْلَة", example: "The strawberry is red and sweet.", category: "Fruits", color: "blue", colloquial: "فَرَاوْلَة", colloquialTransliteration: "Frawlah" , image: "🍓" },
  { arabic: "Mango", transliteration: "Mango", meaning: "مَانْجَا", example: "Mango is a tropical fruit.", category: "Fruits", color: "coral", colloquial: "مَانْجَا", colloquialTransliteration: "Mangaa" , image: "🥭" },
  { arabic: "Pineapple", transliteration: "Pineapple", meaning: "أَنَانَاس", example: "Pineapple is sour and sweet.", category: "Fruits", color: "gold", colloquial: "أَنَانَاس", colloquialTransliteration: "Ananaas" , image: "🍍" },
  { arabic: "Pear", transliteration: "Pear", meaning: "كُمَّثْرَى", example: "The pear is soft and juicy.", category: "Fruits", color: "sage", colloquial: "كُمَّثْرَى", colloquialTransliteration: "Kummathra" , image: "🍐" },
  { arabic: "Peach", transliteration: "Peach", meaning: "خَوْخ", example: "Peach is a summer fruit.", category: "Fruits", color: "blue", colloquial: "خَوْخ", colloquialTransliteration: "Khawkh" , image: "🍑" },
  { arabic: "Cherry", transliteration: "Cherry", meaning: "كَرَز", example: "The cherry is small and tasty.", category: "Fruits", color: "coral", colloquial: "كَرَز", colloquialTransliteration: "Karaz" , image: "🍒" },
  { arabic: "Lemon", transliteration: "Lemon", meaning: "لَيْمُون", example: "I add lemon to my tea.", category: "Fruits", color: "gold", colloquial: "لَيْمُون", colloquialTransliteration: "Laymoon" , image: "🍋" },
  ...
  { arabic: "Coconut", transliteration: "Coconut", meaning: "جَوْزُ الْهِنْد", example: "Coconut has tasty water inside.", category: "Fruits", color: "blue", colloquial: "نَارْجِيل", colloquialTransliteration: "Narjeel" , image: "🥥" },
  { arabic: "Melon", transliteration: "Melon", meaning: "شَمَّام", example: "Melon is refreshing in summer.", category: "Fruits", color: "coral", colloquial: "شَمَّام", colloquialTransliteration: "Shammaam" , image: "🍈" },
  { arabic: "Kiwi", transliteration: "Kiwi", meaning: "كِيوِي", example: "The kiwi is green inside.", category: "Fruits", color: "gold", colloquial: "كِيوِي", colloquialTransliteration: "Kiwi" , image: "🥝" },
